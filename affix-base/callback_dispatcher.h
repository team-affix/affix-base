...
namespace affix_base
{
	namespace callback
	{
		...
		public:
			...
			{
				affix_base::threading::locked_resource<size_t, MUTEX_TYPE> l_dispatched_count = m_dispatched_count.lock();
				return l_dispatched_count.resource();
			}

			/// <summary>
			/// Returns a boolean describing whether there are any active dispatches.
			/// </summary>
			/// <returns></returns>
			bool dispatched(
